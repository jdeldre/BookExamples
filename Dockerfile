...
USER $NB_USER
RUN julia -e "using Pkg; pkg\"up; add PackageCompiler Plots Conda PyCall PyPlot PotentialFlow\"; using Conda; Conda.add(\"matplotlib\"); Conda.add(\"pyqt\"); using PackageCompiler; compile_incremental(:Plots, :PyPlot, :PotentialFlow, force = true)"
# QELP, QELAP
